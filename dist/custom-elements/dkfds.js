...
class FDSTooltipIcon extends HTMLElement {
  ...
  #setTooltipWidth() {
    ...
    // Cap at max width
    if (tooltip.offsetWidth > FDSTooltipIcon.#MAX_WIDTH) {
      tooltip.style.width = `${FDSTooltipIcon.#MAX_WIDTH}px`;
    }
  ...
  #setTooltipLeft() {
    ...
    if (left < FDSTooltipIcon.#MIN_MARGIN) {
      left = FDSTooltipIcon.#MIN_MARGIN;
    }
